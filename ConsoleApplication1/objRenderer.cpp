...
void RenderFrame(void)
{
	...
	//		  matWorld = matTranslate x matRotateX x matRotateY x matRotateZ x matScale (translate first, providing a different result because when it is used first it offsets the object from the origin (0, 0, 0) before rotation takes place relative to the origin)
	//
